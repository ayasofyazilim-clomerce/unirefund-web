...
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@repo/ayasofyazilim-ui/atoms/command";
...
export function AddressCombobox({
    ...
    const selectedItem = list?.find((item) =>
        (item as any)[selectIdentifier] === value
    );
                                    ...
                                    return (
                                        ...
                                        >
                                            <Check
                                                className={cn(
                                                    "mr-2 h-4 w-4",
                                                    value === itemKey ? "opacity-100" : "opacity-0"
                                                )}
                                            />
                                            {itemLabel}
                                        </CommandItem>
