  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="inline-flex items-center justify-center rounded-lg p-0 text-sm font-medium leading-none text-gray-900 hover:bg-gray-100 focus-visible:ring-0 data-[state=open]:ring-2 data-[state=open]:ring-gray-300">
          <>
            {triggerContent}
