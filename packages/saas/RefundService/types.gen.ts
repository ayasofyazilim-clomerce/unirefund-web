...
export type UniRefund_RefundService_Enums_RefundReconciliationStatus =
  | "Approved"
  | "NotApproved"
  | "Error"
  | "InProgress";

export type UniRefund_RefundService_Enums_RefundStatus =
  | "NotPaid"
  | "PendingDeparture"
  | "Blocked"
  | "Processing"
...
export type UniRefund_RefundService_Refunds_GetListAsync_RefundTextFilterType =
...
export type GetApiRefundServiceRefundsRefundStatisticsResponse =
  UniRefund_RefundService_Refunds_GetRefundStatistics_RefundStatistics;

export type GetApiRefundServiceRefundsByIdDetailData = {
  id: string;
};

export type GetApiRefundServiceRefundsByIdDetailResponse =
  UniRefund_RefundService_Refunds_GetDetailAsync_RefundDetailDto;

export type GetApiRefundServiceRefundsTagByIdDetailData = {
  id: string;
};

export type GetApiRefundServiceRefundsTagByIdDetailResponse =
  UniRefund_RefundService_Refunds_GetDetailAsync_RefundDetailDto;
