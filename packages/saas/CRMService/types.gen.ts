...
export type UniRefund_CRMService_Customs_CustomStatus =
  | "DRAFT"
  | "WAITINGAPPROVAL"
  | "APPROVED"
  | "REJECTED"
...
export type UniRefund_CRMService_Merchants_MerchantStatus =
  | "DRAFT"
  | "WAITINGAPPROVAL"
  | "APPROVED"
  | "REJECTED"
...
export type UniRefund_CRMService_RefundPoints_RefundPointStatus =
  | "DRAFT"
  | "WAITINGAPPROVAL"
  | "APPROVED"
  | "REJECTED"
...
export type UniRefund_CRMService_TaxFrees_TaxFreeStatus =
  | "DRAFT"
  | "WAITINGAPPROVAL"
  | "APPROVED"
  | "REJECTED"
...
export type UniRefund_CRMService_TaxOffices_TaxOfficeStatus =
  | "DRAFT"
  | "WAITINGAPPROVAL"
  | "APPROVED"
  | "REJECTED"
...
export type UniRefund_Shared_Contracts_Enums_PartyType =
  | "INDIVIDUAL"
  | "MERCHANT"
  | "REFUNDPOINT"
  | "CUSTOM"
...
export type GetApiCrmServiceAdminarealevel1ByAdminAreaLevel1IdResponse =
...
export type PutApiCrmServiceAdminarealevel1ByAdminAreaLevel1IdResponse =
  UniRefund_CRMService_AdminAreaLevel1_AdminAreaLevel1Dto;
...
export type GetApiCrmServiceAdminarealevel1ByCountryByCountryIdResponse =
  Array<UniRefund_CRMService_AdminAreaLevel1_AdminAreaLevel1Dto>;
...
export type GetApiCrmServiceAdminarealevel2ByAdminAreaLevel2IdResponse =
...
export type PutApiCrmServiceAdminarealevel2ByAdminAreaLevel2IdResponse =
  UniRefund_CRMService_AdminAreaLevel2_AdminAreaLevel2Dto;
...
export type GetApiCrmServiceAdminarealevel2ByAdminarealevel1ByAdminAreaLevel1IdResponse =
  Array<UniRefund_CRMService_AdminAreaLevel2_AdminAreaLevel2Dto>;
...
export type PutApiCrmServiceCustomsByCustomIdAffiliationsByAffiliationIdResponse =
  UniRefund_CRMService_Affiliations_AffiliationDto;
...
export type GetApiCrmServiceIndividualsByIndividualIdTelephonesResponse =
  Array<UniRefund_CRMService_Telephones_TelephoneDto>;
...
export type GetApiCrmServiceIndividualsByIndividualIdAddressesResponse =
  Array<UniRefund_CRMService_Addresses_AddressDto>;

export type GetApiCrmServiceIndividualsByEmailData = {
  email?: string;
};

export type GetApiCrmServiceIndividualsByEmailResponse =
  Array<UniRefund_CRMService_Individuals_IndividualWithAbpUserDto>;
...
export type PutApiCrmServiceMerchantsByMerchantIdAffiliationsByAffiliationIdResponse =
  UniRefund_CRMService_Affiliations_AffiliationDto;
...
export type GetApiCrmServiceMerchantsByMerchantIdProductGroupResponse =
  Array<UniRefund_SettingService_ProductGroupMerchants_ProductGroupMerchantRelationDto>;
...
export type GetApiCrmServiceMerchantsByMerchantIdTelephonesResponse =
  Array<UniRefund_CRMService_Telephones_TelephoneDto>;
...
export type GetApiCrmServiceNeighborhoodsByAdminarealevel2ByAdminAreaLevel2IdResponse =
  Array<UniRefund_CRMService_Neighborhoods_NeighborhoodDto>;
...
export type PutApiCrmServiceRefundpointsByRefundPointIdAffiliationsByAffiliationIdResponse =
  UniRefund_CRMService_Affiliations_AffiliationDto;
...
export type GetApiCrmServiceRefundpointsByRefundPointIdAddressesResponse =
  Array<UniRefund_CRMService_Addresses_AddressDto>;
...
export type GetApiCrmServiceRefundpointsByRefundPointIdTelephonesResponse =
  Array<UniRefund_CRMService_Telephones_TelephoneDto>;
...
export type PutApiCrmServiceRefundpointsByRefundPointIdTelephonesResponse =
  UniRefund_CRMService_Telephones_TelephoneDto;
...
export type PutApiCrmServiceTaxfreesByTaxFreeIdAffiliationsByAffiliationIdResponse =
  UniRefund_CRMService_Affiliations_AffiliationDto;
...
export type PutApiCrmServiceTaxofficesByTaxOfficeIdAffiliationsByAffiliationIdResponse =
  UniRefund_CRMService_Affiliations_AffiliationDto;
...
export type GetApiCrmServiceTaxofficesByTaxOfficeIdTelephonesResponse =
  Array<UniRefund_CRMService_Telephones_TelephoneDto>;
