...
import {getRefundPointOrganizationsByIdApi} from "@repo/actions/unirefund/CrmService/actions";
...
async function getApiRequests({partyId}: {partyId: string}) {
  try {
    ...
    const apiRequests = await Promise.all([getRefundPointOrganizationsByIdApi(partyId, session)]);
    return {
