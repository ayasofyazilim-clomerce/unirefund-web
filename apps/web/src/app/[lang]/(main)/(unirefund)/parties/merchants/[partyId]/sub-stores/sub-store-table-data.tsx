...
type SubStoreTable = TanstackTableCreationProps<UniRefund_CRMService_Merchants_StoreProfileDto>;

const links: Partial<Record<keyof UniRefund_CRMService_Merchants_StoreProfileDto, TanstackTableColumnLink>> = {};
...
function subStoreTableActions(
  ...
  const actions: TanstackTableTableActionsType<UniRefund_CRMService_Merchants_StoreProfileDto>[] = [];
