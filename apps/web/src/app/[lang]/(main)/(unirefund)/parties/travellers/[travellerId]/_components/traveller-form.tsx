"use client"
import type { UniRefund_TravellerService_Travellers_UpdateTravellerDto, UniRefund_TravellerService_Travellers_TravellerDetailProfileDto } from "@repo/saas/TravellerService";
...
export function EditTraveller({
    ...
    return (<SchemaForm<UniRefund_TravellerService_Travellers_UpdateTravellerDto>
        disabled={isPending}
