...
import {getRefundPointPhoneByIdApi} from "@repo/actions/unirefund/CrmService/actions";
...
async function getApiRequests({partyId}: {partyId: string}) {
  try {
    ...
    const apiRequests = await Promise.all([getRefundPointPhoneByIdApi(partyId, session)]);
    return {
