...
import type {GetApiCrmServiceTaxFreesByIdTelephonesResponse} from "@ayasofyazilim/saas/CRMService";
...
import {putTaxFreeTelephoneApi} from "@repo/actions/unirefund/CrmService/put-actions";
...
function TelephoneForm({
  ...
  partyId: string;
  phoneResponse: GetApiCrmServiceTaxFreesByIdTelephonesResponse;
}) {
