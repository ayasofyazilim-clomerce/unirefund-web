...
import type { GetApiCrmServiceRefundPointsByIdSubRefundPointsResponse } from "@ayasofyazilim/saas/CRMService";
...
function SubStoresTable({
  ...
  response: GetApiCrmServiceRefundPointsByIdSubRefundPointsResponse;
