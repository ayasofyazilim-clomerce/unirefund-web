...
function RefundPointsTable({
  ...
  const columns = tableData.refundPoints.columns(lang, languageData, grantedPolicies);
  const table = tableData.refundPoints.table(languageData, router, grantedPolicies);
