...
import {getTaxOfficeOrganizationsByIdApi} from "@repo/actions/unirefund/CrmService/actions";
...
async function getApiRequests({partyId}: {partyId: string}) {
  try {
    ...
    const apiRequests = await Promise.all([getTaxOfficeOrganizationsByIdApi(partyId, session)]);
    return {
