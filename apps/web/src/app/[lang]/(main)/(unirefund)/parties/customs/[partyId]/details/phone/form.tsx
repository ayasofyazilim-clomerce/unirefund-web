...
import type {GetApiCrmServiceCustomsByIdTelephonesResponse} from "@ayasofyazilim/saas/CRMService";
...
import {putCustomTelephoneApi} from "@repo/actions/unirefund/CrmService/put-actions";
...
function TelephoneForm({
  ...
  partyId: string;
  phoneResponse: GetApiCrmServiceCustomsByIdTelephonesResponse;
}) {
