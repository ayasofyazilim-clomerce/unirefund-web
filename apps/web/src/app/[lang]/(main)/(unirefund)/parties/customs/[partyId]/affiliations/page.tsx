...
import {getCustomAffiliationsByIdApi} from "@repo/actions/unirefund/CrmService/actions";
import type {GetApiCrmServiceCustomsByIdAffiliationsData} from "@repo/saas/CRMService";
...
async function getApiRequests(filters: GetApiCrmServiceCustomsByIdAffiliationsData, session: Session | null) {
  try {
    const requiredRequests = await Promise.all([getCustomAffiliationsByIdApi(filters, session)]);
