import { getTravellerAddressesByTravellerIdApi, getTravellerEmailsByTravellerIdApi, getTravellerTelephonesByTravellerIdApi } from "@repo/actions/unirefund/TravellerService/actions";
...
export async function TravellerContact({
    params
}: {
    params: { lang: string; travellerId: string };
}) {
