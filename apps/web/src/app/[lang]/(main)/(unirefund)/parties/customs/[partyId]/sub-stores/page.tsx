...
import {GetApiCrmServiceCustomsData} from "@ayasofyazilim/unirefund-saas-dev/CRMService";
...
export default async function Page({
  ...
  return <SubStoresTable languageData={languageData} customs={subStoresResponse.data} newLink="sub-stores/new" />;
}
