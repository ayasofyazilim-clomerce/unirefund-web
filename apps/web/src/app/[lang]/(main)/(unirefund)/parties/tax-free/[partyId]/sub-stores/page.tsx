...
import {GetApiCrmServiceTaxfreesData} from "@ayasofyazilim/unirefund-saas-dev/CRMService";
...
export default async function Page({
  ...
  return <SubStoresTable languageData={languageData} taxFrees={subStoresResponse.data} newLink="sub-stores/new" />;
}
