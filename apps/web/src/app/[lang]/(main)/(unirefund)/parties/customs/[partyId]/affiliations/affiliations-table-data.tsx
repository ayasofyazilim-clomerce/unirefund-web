...
import {deleteCustomsByIdAffiliationsByAffiliationIdApi} from "@/actions/unirefund/CrmService/delete-actions";
import {
...
function affiliationsRowActions(
  ...
  if (isActionGranted(["CRMService.Customs.DeleteAffiliation"], grantedPolicies)) {
    actions.push({
      type: "confirmation-dialog",
      ...
      icon: Trash,
      onConfirm: (row) => {
        void deleteCustomsByIdAffiliationsByAffiliationIdApi({
          id: partyId,
