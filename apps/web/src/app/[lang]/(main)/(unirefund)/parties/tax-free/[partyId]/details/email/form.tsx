...
import type {GetApiCrmServiceTaxFreesByIdEmailsResponse} from "@ayasofyazilim/saas/CRMService";
...
import {putTaxFreeEmailApi} from "@repo/actions/unirefund/CrmService/put-actions";
...
function EmailForm({
  ...
  partyId: string;
  emailResponse: GetApiCrmServiceTaxFreesByIdEmailsResponse;
}) {
