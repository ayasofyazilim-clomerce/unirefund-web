...
import {getTaxOfficePhoneByIdApi} from "@repo/actions/unirefund/CrmService/actions";
...
async function getApiRequests({partyId}: {partyId: string}) {
  try {
    ...
    const apiRequests = await Promise.all([getTaxOfficePhoneByIdApi(partyId, session)]);
    return {
