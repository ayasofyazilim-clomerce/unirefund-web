...
import {putRefundPointEmailApi} from "@repo/actions/unirefund/CrmService/put-actions";
...
function EmailForm({
  ...
  partyId: string;
  emailResponse: GetApiCrmServiceRefundPointsByIdEmailsResponse;
}) {
