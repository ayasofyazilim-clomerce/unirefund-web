...
import type {GetApiCrmServiceTaxofficesData} from "@ayasofyazilim/unirefund-saas-dev/CRMService";
...
export default async function Page({
  ...
  return <SubStoresTable languageData={languageData} newLink="sub-stores/new" taxOffices={subStoresResponse.data} />;
}
