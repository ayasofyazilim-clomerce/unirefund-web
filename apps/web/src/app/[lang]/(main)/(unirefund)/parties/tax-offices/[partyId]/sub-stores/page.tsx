...
import {GetApiCrmServiceTaxofficesData} from "@ayasofyazilim/unirefund-saas-dev/CRMService";
...
export default async function Page({
  ...
  return <SubStoresTable languageData={languageData} taxOffices={subStoresResponse.data} newLink="sub-stores/new" />;
}
