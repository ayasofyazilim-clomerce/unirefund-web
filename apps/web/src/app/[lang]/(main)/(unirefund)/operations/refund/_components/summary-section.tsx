  ...
  return (
    <div className="mb-2 grid grid-cols-5 gap-5">
      <TagSummary
        ...
        value={totalDataOfSelectedTags.salesAmount || 0}
      />
      <TagSummary
        title={languageData.VatAmount}
        value={totalDataOfSelectedTags.vatAmount || 0}
      />
      <TagSummary
        title={languageData.GrossRefund}
        value={totalDataOfSelectedTags.grossRefund || 0}
      />
      ...
      <TagSummary
        ...
        value={totalDataOfSelectedTags.refund || 0}
      />
    </div>
  );
}
