...
export async function getIndividualNameByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.individual.getApiCrmServiceIndividualsByIdName({
        id,
      });
    return structuredSuccessResponse(response);
  } catch (error) {
...
export async function getIndividualPersonalSummaryByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.individual.getApiCrmServiceIndividualsByIdPersonalSummaries(
        {
          id,
        },
      );
...
export async function getTaxFreeAddressByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.taxFree.getApiCrmServiceTaxFreesByIdAddresses({
        id,
      });
    return structuredSuccessResponse(response);
  } catch (error) {
...
export async function getIndividualAddressByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.individual.getApiCrmServiceIndividualsByIdAddresses({
        id,
      });
    return structuredSuccessResponse(response);
  } catch (error) {
...
export async function getTaxFreeEmailByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
...
export async function getIndividualEmailByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.individual.getApiCrmServiceIndividualsByIdEmails({
        id,
      });
    return structuredSuccessResponse(response);
  } catch (error) {
...
export async function getTaxFreePhoneByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
...
export async function getIndividualPhoneByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.individual.getApiCrmServiceIndividualsByIdTelephones({
        id,
      });
    return structuredSuccessResponse(response);
  } catch (error) {
...
export async function getCustomDetailsByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
...
export async function getTaxFreeDetailsByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
...
export async function getTaxOfficeDetailsByIdApi(
  id: string,
  session?: Session | null,
) {
  try {
    const crmClient = await getCRMServiceClient(session);
    const response =
      await crmClient.taxOffice.getApiCrmServiceTaxOfficesByIdDetail({
        id,
      });
    return structuredSuccessResponse(response);
  } catch (error) {
